...
export default class ICEScriptListener extends antlr4.tree.ParseTreeListener {
	...
	// Enter a parse tree produced by ICEScriptParser#classBody.
	enterClassBody(ctx) {
	}

	// Exit a parse tree produced by ICEScriptParser#classBody.
	exitClassBody(ctx) {
	}


	// Enter a parse tree produced by ICEScriptParser#classInit.
	enterClassInit(ctx) {
	}

	// Exit a parse tree produced by ICEScriptParser#classInit.
	exitClassInit(ctx) {
	}
	...
	// Enter a parse tree produced by ICEScriptParser#object.
	enterObject(ctx) {
	}

	// Exit a parse tree produced by ICEScriptParser#object.
	exitObject(ctx) {
	}
	...
	// Enter a parse tree produced by ICEScriptParser#data.
	enterData(ctx) {
	}

	// Exit a parse tree produced by ICEScriptParser#data.
	exitData(ctx) {
	}
