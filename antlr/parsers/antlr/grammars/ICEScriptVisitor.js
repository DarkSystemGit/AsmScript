...
export default class ICEScriptVisitor extends antlr4.tree.ParseTreeVisitor {
	...
	// Visit a parse tree produced by ICEScriptParser#classDef.
	visitClassDef(ctx) {
	  return this.visitChildren(ctx);
	}
	...
	// Visit a parse tree produced by ICEScriptParser#classInit.
	visitClassInit(ctx) {
	  return this.visitChildren(ctx);
	}
	...
	// Visit a parse tree produced by ICEScriptParser#object.
	visitObject(ctx) {
	  return this.visitChildren(ctx);
	}
	...
	// Visit a parse tree produced by ICEScriptParser#data.
	visitData(ctx) {
	  return this.visitChildren(ctx);
	}
